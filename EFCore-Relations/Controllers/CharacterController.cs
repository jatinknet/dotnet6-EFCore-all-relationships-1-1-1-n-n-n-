...
using EFCore_Relations.Dtos;
using EFCore_Relations.Entities;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace EFCore_Relations.Controllers
{
    ...
    public class CharacterController : ControllerBase
    {
        ...
        {
            var characters = await _context.Characters.Where(x => x.UserId == userId)
                .Include(x=>x.Weapon)
                .Include(x=>x.Skills)
                .ToListAsync();
